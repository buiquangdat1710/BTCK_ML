...
5. Vượt qua **toàn bộ** bảng benchmark ở các chỉ số F1-Score và AUC
...
**Ngưỡng cần vượt:** F1 > 0.9801 trên tập test, F1 > 0.9700 trên tập challenge.
...
Chuẩn bị slide (PowerPoint, Google Slides, hoặc PDF) để trình bày trước nhóm, tối đa **12 slide**, theo cấu trúc sau:

| Slide | Nội dung |
|-------|----------|
| 1 | Tiêu đề, tên thành viên nhóm |
...
Mỗi nhóm có **10–15 phút** trình bày và **5 phút** hỏi đáp. Người hỏi có thể là giảng viên hoặc các nhóm khác.
...
| Tiêu chí | Mô tả |
|----------|-------|
| Hiểu bài toán | Nhóm có thực sự hiểu dữ liệu mình đang làm việc không? |
...
| Phân tích thất bại | Nhóm có thử nhiều hướng và rút ra được bài học không? |
